 ...
 export default class dicionario extends Component<Props> {
   state = {
     contents: [
       ...
       {
         title: 'Imperialismo',
         body: 'É a prática através da qual, nações poderosas procuram ampliar e manter controle ou influência sobre povos ou nações mais pobres.\nAlgumas vezes o imperialismo é associado somente com a expansão econômica dos países capitalistas; outras vezes é usado para designar a expansão europeia após 1870. Embora Imperialismo signifique o mesmo que Colonialismo e os dois termos sejam usados da mesma forma, devemos fazer a distinção entre um e outro.Colonialismo normalmente implica em controle político, envolvendo anexação de território e perda da soberania.\n\nFonte: https://www.infoescola.com/historia/imperialismo/',
       },
       {
         title: 'Indústria Cultural',
         body: 'Na sociedade de consumo, o lazer é algo vendido pela Indústria Cultural. Ele passou a ser explorado exageradamente pela indústria do entretenimento e pelos meios de comunicação de massa, transformando-o em mais um produto, como a moda, os eventos culturais, o turismo, as produções literárias e audiovisuais e etc.\nA indústria cultural constrói modelos de comportamento padronizados, que não são criticados pelos indivíduos, o que leva a um consumidor passivo.\nA indústria cultural envolve a produção em série de grandes quantidades de produtos comercializados visando o lucro, provocando dependência e seduzindo para o consumo de mercadorias.',
       },
       {
         title: 'Liberalismo',
         body: '“Economicamente, o liberalismo é uma teoria capitalista, que defende a livre-iniciativa e a ausência de interferências do Estado no mercado (...).\nA Sociologia define liberalismo como um complexo de teorias e práticas construído no processo histórico de laicização e de especialização do poder político. Enquanto a laicização significa a separação do Estado e da religião, a especialização do poder político implica a divisão e independência dos poderes que constituem o Estado, ou seja, o Legislativo, Judiciário e Executivo, limitando o poder do soberano, retirando de suas mãos as funções de governar, criar leis e executar justiça ao mesmo tempo (...).\nO liberalismo foi compreendido e praticado como o regime que garantia a liberdade inalienável de o indivíduo possuir propriedade privada. Um de seus fundamentos era a afirmação de que o Estado não deveria intervir nos interesses individuais (...).\nO liberalismo pode ser entendido como uma ideologia que concede espaços à iniciativa e à autonomia individuais. Nessa filosofia, as ações dos indivíduos, desde que respaldadas por normas legais (e nesse caso o Direito é fundamental para a instituição de uma sociedade liberal), podem manter uma autonomia relativa ante o Estado. Este, por sua vez, deve exercer algumas funções específicas, limitadas, mas essenciais à ação livre dos cidadãos proprietários. Desse modo, há estreita relação entre o liberalismo político e o liberalismo econômico, na medida em que o Estado se estrutura para garantir os contratos, não interferir nos lucros de seus membros, permitir a manutenção da propriedade privada, regular o jogo de interesses, manter a ordem social (...).\nPrecisamos ainda ficar alertas, pois os discursos, incorporados pelo senso comum, tendem a associar o liberalismo/neoliberalismo à democracia, à prosperidade econômica e à igualdade, o que configura uma postura a-histórica e muitas vezes inverossímil, porque liberalismo, democracia e igualdade social não são sinônimos nem sempre andaram juntos. Na verdade, o neoliberalismo chega mesmo a pregar a desigualdade social.\nPor último, precisamos observar a realidade concreta e cotidiana em que nossos alunos estão inseridos, pois hoje um número cada vez maior de pessoas trabalha no mercado informal ou temporário, sem os benefícios mais básicos, como salário mínimo, 13º, férias etc. Além disso, as privatizações levam cada vez mais a saúde e a educação para longe do alcance da maioria. Como essas são práticas neoliberais, é possível atrelar a discussão do tema a problemas básicos enfrentados pelas famílias de alunos e professores” (SILVA, 2009, p. 257-262). \n\nSILVA, Kalina Vanderlei. Dicionário de conceitos históricos. 2.ed. São Paulo: Contexto, 2009.',
       },
        {
         title: 'Poder',
         body: 'Probabilidade de impor a própria vontade numa relação social, mesmo com resistência.',
       },
        {
         title: 'Raça',
         body: 'Raça tem somente um significado científico e é biologicamente única. Refere-se a uma única subdivisão das espécies conhecidas, membros de uma herança física, a qual visa distinguir-se de outras populações da mesma espécie. Apesar desta definição ser precisa tanto quanto possível, os cientistas entendem que não existem claras subdivisões na única espécie chamada homem, isto é, o homo sapiens. A maior parte das pessoas pertencem a categorias entre subdivisões do que propriamente àquela da qual pertencem, ou de que um mesmo indivíduo pode ter características que o colocam em diversas categorias simultaneamente.\n\nFonte: https://www.geledes.org.br/o-que-e-raca/?gclid=CjwKCAjw87SHBhBiEiwAukSeUZ5AZwahBUvsAXX27sxVDPrG4cqf7E8n74cQZE2fe37dN0a_Ovcw1xoCyuUQAvD_BwE ',
       },
        {
         title: 'Relativização',
         body: '"Existem idéias que se contrapõem ao etnocentrismo. Uma das mais importantes é a de relativização. Quando vemos que as verdades da vida são menos uma questão de essência das coisas e mais uma questão de posição: estamos relativizando. Quando o significado de um ato é visto não na sua dimensão absoluta mas no contexto em que acontece: estamos relativizando. Quando compreendemos o “outro” nos seus próprios valores e não nos nossos: estamos relativizando. Enfim, relativizar é ver as coisas do mundo como uma relação capaz de ter tido um nascimento, capaz de ter um fim ou uma transformação. Ver as coisas do mundo como a relação entre elas. Ver que a verdade está mais no olhar que naquilo que é olhado. Relativizar é não transformar a diferença em hierarquia, em superiores e inferiores ou em bem e mal, mas vê-la na sua dimensão de riqueza por ser diferença” (ROCHA, 1988, p. 9).\n\nROCHA, Everardo P. Guimarães. O que é etnocentrismo. 5 ed. São Paulo: Brasiliense, 1988.',
       },
        {
         title: 'Sexualidade',
         body: 'A sexualidade diz respeito à orientação sexual de uma pessoa, ou seja, por quais gêneros essa pessoa sente atração sexual ou romântica. Algumas das categorias atribuídas à sexualidade são: heterossexualidade (pessoa que sente atração por pessoa do gênero oposto); homossexualidade (pessoa que sente atração por pessoa do mesmo gênero); bissexualidade (pessoa que sente atração por pessoas dos dois gêneros).\n\nFonte: https://www.politize.com.br/vamos-falar-sobre-genero/',
       },
