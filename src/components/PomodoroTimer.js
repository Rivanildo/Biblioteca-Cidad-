...
class PomodoroTimer extends React.Component {
	...
	handleWorkTime = (text) =>
	{
		if(text >= 0)
		{
			...
			alert("Período de tempo inválido. Altere o valor. Por favor, insira um tempo válido")
			this.setState({
				workTime: 25
			})
		}
			...
			<View>
				<View style={styles.row}>
					<View style={styles.inputWrap}>
						<Text style={styles.textStyle}>Tempo de foco</Text>
					...
					<View style={styles.inputWrap}>
						<Text style={styles.textStyle}>Tempo de pausa</Text>
